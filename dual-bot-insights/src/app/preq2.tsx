...
export default function Body({changeStage}: {changeStage:() => void}) {
    ...
    return (
        <div className="relative flex flex-col justify-center items-center w-full text-[2.5vw] sm:text-[2.5vw] md:text-[2.5vw] lg:text-[1.75vw] h-[350vw] sm:h-[350vw] md:h-[350vw] lg:h-[225vw]">
            <h1 className="mb-2 text-center">
            Below are a number of characteristics that may or may not apply to you. For example, do you agree that you are someone who likes to spend time with others? Please select each statement to indicate the extent to which you agree or disagree with that statement.<br></br><br></br><i> I am someone who:</i>
            </h1>
