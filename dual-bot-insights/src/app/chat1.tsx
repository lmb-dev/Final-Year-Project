...
export default function Chat1({ changeStage, createList }: { changeStage: () => void; createList: (intArray: number[]) => void }) {
    ...
    const { messages, input, handleInputChange, handleSubmit} = useChat({
        ...
        initialMessages: [
            {
                id: '',
                content: 'Your purpose is to talk about Animals and Animals only. Do not answer requests or questions not related to it directly. Do not justify your answers. You are indifferent to everything but still use an unapologetic assertive tone. Be concise but informative.',
                role: 'system'
            }
        ],
    })
