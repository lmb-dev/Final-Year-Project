...
export default function Chat1({changeStage}: {changeStage:() => void}) {
    ...
    const { messages, input, handleInputChange, handleSubmit} = useChat({
        ...
        initialMessages: [
            {
                id: '',
                content: 'Your purpose is to talk about Animals and Animals only. Do not answer requests or questions not related to it directly. Do not justify your answers. You are indifferent to everything but still use an unapologetic assertive tone. Be detailed but also concise and clear.',
                role: 'system'
            }
        ],
    })
    ...
    return (
        <div className="relative flex flex-col mx-auto w-[80%] md:w-[65%] mt-[-40vw] sm:mt-[-40vw] md:mt-[-30vw] lg:mt-[-25vw] text-[3vw] sm:text-[2.5vw] md:text-[2vw] lg:text-[1.25vw]">
            ...
            <h1 className="mb-4 text-center">
                You can now speak freely to Cri/ter-B0t by typing into the box below. You can have <span className="font-semibold">up to five minutes of conversation</span>, but do not have to use the whole time.<br></br>Use this time to see what Cri/ter-B0t can do, and learn about animals!   
            </h1>
